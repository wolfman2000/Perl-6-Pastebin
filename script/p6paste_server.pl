...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{P6PASTE_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{P6PASTE_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
p6paste_server.pl - Catalyst Testserver

=head1 SYNOPSIS

p6paste_server.pl [options]
